...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import LibVPX_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("dd192d2f-8180-539f-9fb4-cc70b1dcf69a"))
platforms = [Pkg.Artifacts.unpack_platform(e, "LibVPX", artifacts_toml) for e in artifacts["LibVPX"]]
...
if best_platform === nothing
    @debug("Unable to load LibVPX; unsupported platform $(triplet(platform_key_abi()))")
else
